...
A Node.js + Express + MongoDB based web application that allows users to scan websites for security configurations, SSL status, HTTP headers, CORS policy, and potential vulnerabilities.
